...
from api.views.HeatView import HeatView, LaneView
...
urlpatterns = [
    ...
    path('meet_schools/<int:meet_id>/', MeetSchoolView.as_view(), name='meet_schools'),
    path('meet_event/<int:meet_id>/', MeetEventView.as_view(), name='events_meet'),
    path('seed_times/<int:event_id>/', AthleteSeedTimeView.as_view(), name='seed_times'),
    path('event_heat/<int:event_id>/', GenerateHeatView.as_view(), name='heats_event'),
    path('event_heat/<int:event_id>/<int:heat_num>/', HeatView.as_view(), name='heat_detail'),
    path('event_lane/<int:event_id>/<int:lane_num>/', LaneView.as_view(), name='lane_detail'),
    path('event_result/<int:event_id>/', EventResultView.as_view(), name='event_result'),
]
